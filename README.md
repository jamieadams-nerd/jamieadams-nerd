...
## Key NIST Cybersecurity Publications (Including Post-Quantum Cryptography)

This document lists the most widely used and foundational NIST publications in
...
- **SP 800-60 Vol. 1 & Vol. 2 — Categorizing Information and Information Systems**  
  https://csrc.nist.gov/publications/detail/sp/800-60/vol-1-rev-1/final  

---

### 🏛️ FISMA / Federal Guidance
...
### 🔐 Cryptography & Validation (Pre-PQC Traditional Crypto)
- **FIPS 140-3 — Security Requirements for Cryptographic Modules**  
  https://csrc.nist.gov/publications/detail/fips/140/3/final  
- **SP 800-56 (A/B/C) — Key Establishment**  
  - 56A: https://csrc.nist.gov/publications/detail/sp/800-56a/rev-3/final  
  - 56B: https://csrc.nist.gov/publications/detail/sp/800-56b/rev-2/final  
  - 56C: https://csrc.nist.gov/publications/detail/sp/800-56c/rev-2/final  
- **SP 800-57 Series — Key Management**  
  https://csrc.nist.gov/projects/key-management  
- **SP 800-90 Series — Random Number Generation**  
  https://csrc.nist.gov/projects/random-bit-generation  
- **SP 800-131A Rev. 2 — Use of Cryptographic Algorithms**  
  https://csrc.nist.gov/publications/detail/sp/800-131a/rev-2/final  

---

### ⚛️ **Post-Quantum Cryptography (PQC) Standards**
NIST’s officially selected PQC algorithms (2022–2024) standardized as FIPS:

- **FIPS 203 — ML-KEM (Kyber-based Key Encapsulation)**  
  https://csrc.nist.gov/publications/detail/fips/203/final  

- **FIPS 204 — ML-DSA (Dilithium-based Digital Signatures)**  
  https://csrc.nist.gov/publications/detail/fips/204/final  

- **FIPS 205 — SLH-DSA (SPHINCS+ Hash-Based Signatures)**  
  https://csrc.nist.gov/publications/detail/fips/205/final  

- **FIPS 206 — ML-KEM/ML-DSA Composition Requirements**  
  https://csrc.nist.gov/publications/detail/fips/206/final  

- **NIST PQC Project Main Page (Round 3 & Round 4)**  
...
- **SP 800-172 — Enhanced Security Requirements for CUI**  
...
- **SP 800-63-3 — Digital Identity Guidelines**  
  - Overview: https://csrc.nist.gov/publications/detail/sp/800-63/3/final  
  - 63A: https://csrc.nist.gov/publications/detail/sp/800-63a/rev-3/final  
  - 63B: https://csrc.nist.gov/publications/detail/sp/800-63b/final  
  - 63C: https://csrc.nist.gov/publications/detail/sp/800-63c/rev-3/final  
- **SP 800-162 — Attribute-Based Access Control (ABAC)**  
...
- **SP 800-34 Rev. 1 — Contingency Planning Guide**  
  https://csrc.nist.gov/publications/detail/sp/800-34/rev-1/final  

---

### 🔍 Vulnerability, Assessments, & Testing
- **SP 800-115 — Technical Guide to Security Testing & Assessment**  
  https://csrc.nist.gov/publications/detail/sp/800-115/final  
- **SP 800-40 Rev. 3 — Patch & Vulnerability Management**  
  https://csrc.nist.gov/publications/detail/sp/800-40/rev-3/final  

---

### 🔑 Hardware & Platform Security
- **SP 800-193 — Platform Firmware Resiliency (PFR) Guidelines**  
...
- **SP 800-188 — De-Identification of Personal Information**  
  https://csrc.nist.gov/publications/detail/sp/800-188/draft  

---

### 🔧 Additional Foundational Frameworks
